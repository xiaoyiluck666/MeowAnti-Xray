...
public final class MeowAntiXrayMixinPlugin implements IMixinConfigPlugin {
    ...
    private static ClassNode readClassNode(String className) {
        ...
        try (InputStream stream = MeowAntiXrayMixinPlugin.class.getClassLoader().getResourceAsStream(resourceName)) {
            if (stream == null) {
                return null;
            }
    ...
    private static String classResource(String className) {
        ...
        return MeowAntiXrayMixinPlugin.class.getClassLoader().getResource(resourceName) == null ? null : resourceName;
    }
